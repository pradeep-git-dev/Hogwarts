...
class Classroom(models.Model):
    ...
    teacher = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='classrooms_taught'
    )
...
class ClassMember(models.Model):
    ...
    student = models.ForeignKey(
        User, on_delete=models.CASCADE, related_name='enrolled_classrooms'
    )
...
class Discussion(models.Model):
    ...
    classroom = models.ForeignKey(
        Classroom, on_delete=models.CASCADE, related_name='discussions'
    )
    author = models.ForeignKey(User, on_delete=models.CASCADE)

    title = models.CharField(max_length=255)
    content = models.TextField()
    topic = models.CharField(max_length=30, choices=TOPICS, default='general')
